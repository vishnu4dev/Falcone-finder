...
import {
  ...
  fetchVehicles,
  findFalcone
} from "../redux/service/main.service";
import {
  incrementVehicleCount,
  decrementVehicleCount,
  updateTotalSearchTime
} from "../redux/action/searchAction";
import PlanetShipSelection from "../components/PlantShipSelection";
import MainBg from '../assets/falcone-3.png';
        ...
        <Paper classes={{root:classes.root}}>
          {planets.length && vehicles.length ? (
            <Grid container direction="row" justify="center">
              ...
              <Grid container className={classes.buttonSet}>
...
const mapStateToProps = state => ({
  ...
  errorText: state.toastReducer.errorText
});
